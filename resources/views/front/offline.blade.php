  ...
  <div class='scene-button'>
    <div class='btn'>
      <div class='btn-info'>
        ...
        <p class='btn-author'>Göktug Ceyhan</p>
        <p class='btn-copy'>"XCODE" Geleceğin Projesi</p>
...
@keyframes btn_noise {
  0% {
    clip: rect(18rem, 50rem, 21rem, -25rem);
  ...
  7.5% {
    clip: rect(15rem, 50rem, 20rem, -25rem);
  ...
  20% {
    clip: rect(9rem, 50rem, 16rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.2);
  }
  22.5% {
    clip: rect(18rem, 50rem, 20rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.225);
  }
  25% {
    clip: rect(7rem, 50rem, 17rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.25);
  }
  27.5% {
    clip: rect(11rem, 50rem, 5rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.275);
  }
  30% {
    clip: rect(17rem, 50rem, 7rem, -25rem);
  ...
  35% {
    clip: rect(17rem, 50rem, 4rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.35);
  }
  37.5% {
    clip: rect(9rem, 50rem, 4rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.375);
  }
  40% {
    clip: rect(21rem, 50rem, 12rem, -25rem);
  ...
  45% {
    clip: rect(8rem, 50rem, 4rem, -25rem);
  ...
  50% {
    clip: rect(24rem, 50rem, 1rem, -25rem);
  ...
  60% {
    clip: rect(5rem, 50rem, 25rem, -25rem);
  ...
  80% {
    clip: rect(20rem, 50rem, 16rem, -25rem);
  ...
  85% {
    clip: rect(15rem, 50rem, 4rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.85);
  }
  87.5% {
    clip: rect(2rem, 50rem, 11rem, -25rem);
    box-shadow: 0 0 30px rgba(255, 255, 255, 0.875);
  }
  90% {
    clip: rect(14rem, 50rem, 25rem, -25rem);
  ...
  95% {
    clip: rect(16rem, 50rem, 2rem, -25rem);
...
@keyframes btn_noise2 {
  0% {
    clip: rect(8rem, 50rem, 16rem, -25rem);
  }
  2.5% {
    clip: rect(14rem, 50rem, 24rem, -25rem);
  }
  5% {
    clip: rect(21rem, 50rem, 1rem, -25rem);
  }
  7.5% {
    clip: rect(23rem, 50rem, 13rem, -25rem);
  }
  10% {
  ...
  20% {
    clip: rect(7rem, 50rem, 8rem, -25rem);
  }
  22.5% {
    clip: rect(19rem, 50rem, 9rem, -25rem);
  }
  25% {
    clip: rect(23rem, 50rem, 9rem, -25rem);
  }
  27.5% {
    clip: rect(11rem, 50rem, 25rem, -25rem);
  }
  30% {
    clip: rect(18rem, 50rem, 11rem, -25rem);
  }
  32.5% {
    clip: rect(21rem, 50rem, 18rem, -25rem);
  }
  35% {
    clip: rect(5rem, 50rem, 17rem, -25rem);
  }
  37.5% {
    clip: rect(25rem, 50rem, 20rem, -25rem);
  }
  40% {
    clip: rect(6rem, 50rem, 3rem, -25rem);
  }
  42.5% {
    clip: rect(8rem, 50rem, 12rem, -25rem);
  }
  45% {
    clip: rect(9rem, 50rem, 17rem, -25rem);
  }
  47.5% {
    clip: rect(14rem, 50rem, 25rem, -25rem);
  }
  ...
  60% {
    clip: rect(7rem, 50rem, 14rem, -25rem);
  }
  62.5% {
    clip: rect(18rem, 50rem, 13rem, -25rem);
  }
  65% {
    clip: rect(13rem, 50rem, 8rem, -25rem);
  }
  67.5% {
    clip: rect(23rem, 50rem, 16rem, -25rem);
  }
  70% {
    clip: rect(13rem, 50rem, 8rem, -25rem);
  }
  ...
  75% {
    clip: rect(23rem, 50rem, 25rem, -25rem);
  }
  77.5% {
  ...
  100% {
    clip: rect(12rem, 50rem, 1rem, -25rem);
  }
}
@keyframes btn_ring {
  0% {
